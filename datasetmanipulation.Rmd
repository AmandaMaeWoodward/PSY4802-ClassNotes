...
```{r}
#finalDat$parentReportGender3<-factor(finalDat$parentReportGender, levels= c("girl", "boy"))
#finalDat$parentReportGender3
...
#### Practice
1. Reorder the parentReportGender variable in your final dataset so that male is the reference category. 
```{r}
